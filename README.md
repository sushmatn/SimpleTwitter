...
* [x] When a network request is sent, user sees a progressbar in the actionbar
...
* [x] User can follow/stop following another user.
* [x] Displaying photos on the user timeline.

## Video Walkthrough 

Here's a walkthrough of implemented user stories:

![twitter2.gif](https://github.com/sushmatn/SimpleTwitter/blob/master/twitter2.gif)
